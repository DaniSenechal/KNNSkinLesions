...
# Danielle Senechal
# kNN code
# This code runs the kNN method either excluding the 
# largest category (NV) or the smaller two categories
# (DTF and VASC)
########################################################
...
training <- rbind(AKIEC.train, BCC.train, BKL.train, DTF.train, MEL.train, VASC.train) 
  # running this version exludes the largest category (NV)

# training <- rbind(AKIEC.train, BCC.train, BKL.train, NV.train, MEL.train) 
  # running this version excludes the smaller two categories (DTF and VASC)
...
testing <- rbind(AKIEC.test, BCC.test, BKL.test, DTF.test, MEL.test, VASC.test) 
  # running this version exludes the largest category (NV)
  
# testing <- rbind(AKIEC.test, BCC.test, BKL.test, NV.test, MEL.test) 
  # running this version excludes the smaller two categories (DTF and VASC)
